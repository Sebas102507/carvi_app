...
import '../../../../model/Exception/permissionException.dart';
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed: ()async{
                                  try{
                                    ...
                                    DataValidator.validateEmail(controllerEmail.text.trim());
                                    authService.signUp(controllerEmail.text,controllerPassword.text);
                                    setState(() {loading=false;});
                                    if (!mounted) return;
                                    Navigator.pop(context);
                                  }catch(e){
                                    setState(() {loading=false;});
                                    if(e is WrongInputException || e is ExistingUserException || e is PermissionException){
